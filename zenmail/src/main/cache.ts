...
// ---------------------------------------------------------------------------
// TODO(multi-account Task 5): remove legacy shim
...
export const localDeltaSince: AccountCache['localDeltaSince'] = (...a) => getDefaultCache().localDeltaSince(...a);
export const clearLocalDeltaTracking: AccountCache['clearLocalDeltaTracking'] = (...a) =>
  getDefaultCache().clearLocalDeltaTracking(...a);
export const upsertThreads: AccountCache['upsertThreads'] = (...a) => getDefaultCache().upsertThreads(...a);
export const getThreads: AccountCache['getThreads'] = (...a) => getDefaultCache().getThreads(...a);
export const getViewRows: AccountCache['getViewRows'] = (...a) => getDefaultCache().getViewRows(...a);
export const isSnoozed: AccountCache['isSnoozed'] = (...a) => getDefaultCache().isSnoozed(...a);
export const getThreadSummary: AccountCache['getThreadSummary'] = (...a) => getDefaultCache().getThreadSummary(...a);
export const cacheThreadDetail: AccountCache['cacheThreadDetail'] = (...a) => getDefaultCache().cacheThreadDetail(...a);
export const getCachedThreadDetail: AccountCache['getCachedThreadDetail'] = (...a) =>
  getDefaultCache().getCachedThreadDetail(...a);
export const applyLabelDelta: AccountCache['applyLabelDelta'] = (...a) => getDefaultCache().applyLabelDelta(...a);
export const searchLocal: AccountCache['searchLocal'] = (...a) => getDefaultCache().searchLocal(...a);
export const listContacts: AccountCache['listContacts'] = (...a) => getDefaultCache().listContacts(...a);
export const addSnooze: AccountCache['addSnooze'] = (...a) => getDefaultCache().addSnooze(...a);
export const dueSnoozes: AccountCache['dueSnoozes'] = (...a) => getDefaultCache().dueSnoozes(...a);
export const removeSnooze: AccountCache['removeSnooze'] = (...a) => getDefaultCache().removeSnooze(...a);
export const addScheduledSend: AccountCache['addScheduledSend'] = (...a) => getDefaultCache().addScheduledSend(...a);
export const dueScheduledSends: AccountCache['dueScheduledSends'] = (...a) => getDefaultCache().dueScheduledSends(...a);
export const removeScheduledSend: AccountCache['removeScheduledSend'] = (...a) =>
  getDefaultCache().removeScheduledSend(...a);
export const bumpScheduledSendAttempt: AccountCache['bumpScheduledSendAttempt'] = (...a) =>
  getDefaultCache().bumpScheduledSendAttempt(...a);
export const getSplits: AccountCache['getSplits'] = (...a) => getDefaultCache().getSplits(...a);
export const replaceSplits: AccountCache['replaceSplits'] = (...a) => getDefaultCache().replaceSplits(...a);
export const getSetting: AccountCache['getSetting'] = (...a) => getDefaultCache().getSetting(...a);
export const setSetting: AccountCache['setSetting'] = (...a) => getDefaultCache().setSetting(...a);
export const addFollowup: AccountCache['addFollowup'] = (...a) => getDefaultCache().addFollowup(...a);
export const dueFollowups: AccountCache['dueFollowups'] = (...a) => getDefaultCache().dueFollowups(...a);
export const setFollowupFired: AccountCache['setFollowupFired'] = (...a) => getDefaultCache().setFollowupFired(...a);
export const removeFollowup: AccountCache['removeFollowup'] = (...a) => getDefaultCache().removeFollowup(...a);
export const listFollowups: AccountCache['listFollowups'] = (...a) => getDefaultCache().listFollowups(...a);
export const getFollowup: AccountCache['getFollowup'] = (...a) => getDefaultCache().getFollowup(...a);
export const clearFollowups: AccountCache['clearFollowups'] = (...a) => getDefaultCache().clearFollowups(...a);
export const enqueueMutation: AccountCache['enqueueMutation'] = (...a) => getDefaultCache().enqueueMutation(...a);
export const listDrainableMutations: AccountCache['listDrainableMutations'] = (...a) =>
  getDefaultCache().listDrainableMutations(...a);
export const bumpMutationAttempt: AccountCache['bumpMutationAttempt'] = (...a) =>
  getDefaultCache().bumpMutationAttempt(...a);
export const removeMutation: AccountCache['removeMutation'] = (...a) => getDefaultCache().removeMutation(...a);
export const hasPendingMutations: AccountCache['hasPendingMutations'] = (...a) =>
  getDefaultCache().hasPendingMutations(...a);
export const mutationQueueDepth: AccountCache['mutationQueueDepth'] = (...a) =>
  getDefaultCache().mutationQueueDepth(...a);
export const overdueScheduledSendCount: AccountCache['overdueScheduledSendCount'] = (...a) =>
  getDefaultCache().overdueScheduledSendCount(...a);
