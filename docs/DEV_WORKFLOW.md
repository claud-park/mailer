...
- **F2 follow-up-reminders 완료**: Goal 0~8 완주. remind-if-no-reply + `h` follow-up + 데몬 3루프 + fired 핀. E2E 58 PASS·0 FAIL(F1 회귀 포함). 디버그 IPC는 `--zenmail-e2e` argv 플래그로 노출. 다음: **F3 Goal 0**.
